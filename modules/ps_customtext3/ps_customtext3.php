...
require_once _PS_MODULE_DIR_ . 'ps_customtext3/classes/CustomText.php';
class Ps_Customtext3 extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Custom 3 text block', [], 'Modules.Customtext.Admin');
        ...
        $this->templateFile = 'module:ps_customtext3/ps_customtext.tpl';
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('saveps_customtext3')) {
    ...
    public function processSaveCustomText()
    {
        ...
        foreach ($shops as $shop) {
            ...
            $info = new CustomText3(Tools::getValue('id_info', 1));
            $info->text = $text;
    ...
    protected function renderForm()
    {
        ...
        $fields_form = [
            'tinymce' => true,
            'legend' => [
                'title' => $this->trans('Custom 3 text block', [], 'Modules.Customtext.Admin'),
            ],
            'input' => [
                'id_info' => [
                    'type' => 'hidden',
        ...
        $helper->module = $this;
        $helper->name_controller = 'ps_customtext3';
        ...
        $helper->submit_action = 'saveps_customtext3';
    ...
    public function getFormValues()
    {
        ...
        $idInfo = CustomText3::getCustomTextIdByShop($idShop);

        Shop::setContext(Shop::CONTEXT_SHOP, $idShop);
        $info = new CustomText3((int) $idInfo);
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ps_customtext3'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('ps_customtext3'));
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        $idInfo = 3; // CustomText::getCustomTextIdByShop($idShop);
        if ($idInfo === false) {
            return false;
        }

        $customText = new CustomText3($idInfo, $this->context->language->id, $idShop);
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = [
            [
                'text' => '<h2>Custom 3 Text Block</h2>
...
<p>Sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.</p>',
    ...
    {
        if ($infoId = CustomText3::getCustomTextIdByShop($params['old_id_shop'])) {
            Shop::setContext(Shop::CONTEXT_SHOP, $params['old_id_shop']);
            $oldInfo = new CustomText3($infoId);

            Shop::setContext(Shop::CONTEXT_SHOP, $params['new_id_shop']);
            $newInfo = new CustomText3($infoId, null, $params['new_id_shop']);
