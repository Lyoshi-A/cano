...
require_once _PS_MODULE_DIR_ . 'ps_customtext2/classes/CustomText.php';
class Ps_Customtext2 extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Custom 2 text block', [], 'Modules.Customtext.Admin');
        ...
        $this->templateFile = 'module:ps_customtext2/ps_customtext.tpl';
    }
    ...
    public function processSaveCustomText()
    {
        ...
        foreach ($shops as $shop) {
            ...
            $info = new CustomText2(Tools::getValue('id_info', 1));
            $info->text = $text;
    ...
    protected function renderForm()
    {
        ...
        $fields_form = [
            'tinymce' => true,
            'legend' => [
                'title' => $this->trans('Custom 2 text block', [], 'Modules.Customtext.Admin'),
            ],
            'input' => [
                'id_info' => [
                    'type' => 'hidden',
    ...
    public function getFormValues()
    {
        ...
        $idInfo = CustomText2::getCustomTextIdByShop($idShop);

        Shop::setContext(Shop::CONTEXT_SHOP, $idShop);
        $info = new CustomText2((int) $idInfo);
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        $idInfo = 2; // CustomText::getCustomTextIdByShop($idShop);
        if ($idInfo === false) {
            return false;
        }

        $customText = new CustomText2($idInfo, $this->context->language->id, $idShop);
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = [
            [
                'text' => '<h2>Custom 2 Text Block</h2>
...
<p>Sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.</p>',
    ...
    {
        if ($infoId = CustomText2::getCustomTextIdByShop($params['old_id_shop'])) {
            Shop::setContext(Shop::CONTEXT_SHOP, $params['old_id_shop']);
            $oldInfo = new CustomText2($infoId);

            Shop::setContext(Shop::CONTEXT_SHOP, $params['new_id_shop']);
            $newInfo = new CustomText2($infoId, null, $params['new_id_shop']);
