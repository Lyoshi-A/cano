...
class MarketplaceManufacturerProductListModuleFrontController extends ModuleFrontController
{
    ...
    public function getBreadcrumbLinks()
    {
        $breadcrumb = [];
        $breadcrumb['links'][] = [
            'title' => $this->module->l('Marketplace', 'manufacturerproductlist'),
            'url' => $this->context->link->getModuleLink('marketplace', 'dashboard'),
        ];
        $breadcrumb['links'][] = [
            'title' => $this->module->l('Brands', 'manufacturerproductlist'),
            'url' => $this->context->link->getModuleLink('marketplace', 'mpmanufacturerlist'),
        ];
        $breadcrumb['links'][] = [
            'title' => $this->l('Brand Products', 'Manufacturer_ProductList'),
            'url' => '',
        ];
