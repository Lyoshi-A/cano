...
$(document).ready(function() {
    if ($('#SubmitAttribute:visible').length) {
        document.querySelector('#SubmitAttribute').addEventListener('click', function() {
            setTimeout(() => this.disabled = true)
        });
    }
    if ($('#SubmitAttributeValue:visible').length) {
        document.querySelector('#SubmitAttributeValue').addEventListener('click', function() {
            setTimeout(() => this.disabled = true)
        });
    }
