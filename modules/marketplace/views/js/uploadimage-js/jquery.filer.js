                ...
                f = {
                    ...
                    _changeInput: function() {
                        ...
                        if (!n.limit || (n.limit && n.limit >= 2)) {
                            //Change according to Marketplace functionality
                            if (typeof upload_single == 'undefined') {
                                //upload only single image through pick image button
                    ...
                    _thumbCreator: {
                                    ...
                                    if (n.templates.canvasImage) {
                                        ...
                                        img.onload = function() {
                                            ...
                                            if (img.width < canvas.width || img.height < canvas.height || steps <= 1) {
                                                ...
                                                //create canvas according to image width
                                                if (img.width >= 1800) {
                                                    var calc_by = 2;
                                                } else if (img.width >= 700 && img.width < 1800) {
                                                    var calc_by = 1.5;
                                                } else {
                                                    var calc_by = 1;
                                                }

                                                context.drawImage(img, 0, 0, img.width * calc_by, img.height* calc_by, 0, 0, optimalWidth, optimalHeight);
                                            }
                        ...
                        _box: function(params) {
                            ...
                            if (l.length < 1) {
                                ...
                                //Change according to Marketplace functionality for single image upload
                                if (typeof upload_single != 'undefined') {
                                    //For creating new DOM with hide old image content
                                    $('.jFiler-items-'+n.name).hide();
                                }
                                ...
                                //Change according to Marketplace functionality
                                if (typeof upload_single != 'undefined') {
                                    //can not upload more than one image through drag&drop in edit profile page
                                    alert(notmorethanone);
                                    return false;
                                }
                            }
                            ...
                            //Change according to Marketplace functionality
                            if (typeof upload_single != 'undefined') {
                                //Add img attibute for delete seller prfile image and shop image of DOM
                                l.find('.wk_delete_img').attr("data-imgtype", n.name);
                            }
                        }
                    },
                    _upload: function(i) {
                    ...
                    _dragDrop: {
                        ...
                        drop: function(e) {
                            ...
                            if (e && e.originalEvent && e.originalEvent.dataTransfer && e.originalEvent.dataTransfer.files && e.originalEvent.dataTransfer.files.length > 0) {
                                //Change according to Marketplace functionality
                                if (typeof upload_single != 'undefined' && e.originalEvent.dataTransfer.files.length > 1) {
                                    //can not upload more than one image through drag&drop in edit profile page
                                    alert(notmorethanone);
                                    return false;
                                } else {
