...
$(document).ready(function() {
    ...
    const dateRangeMapping = {
        'Su': dateRangeJs['weekDaysShort'][0],
        'Mo': dateRangeJs['weekDaysShort'][1],
        'Tu': dateRangeJs['weekDaysShort'][2],
        'We': dateRangeJs['weekDaysShort'][3],
        'Th': dateRangeJs['weekDaysShort'][4],
        'Fr': dateRangeJs['weekDaysShort'][5],
        'Sa': dateRangeJs['weekDaysShort'][6],

        'January': dateRangeJs['months'][0],
        'February': dateRangeJs['months'][1],
        'March': dateRangeJs['months'][2],
        'April': dateRangeJs['months'][3],
        'May': dateRangeJs['months'][4],
        'June': dateRangeJs['months'][5],
        'July': dateRangeJs['months'][6],
        'August': dateRangeJs['months'][7],
        'September': dateRangeJs['months'][8],
        'October': dateRangeJs['months'][9],
        'November': dateRangeJs['months'][10],
        'December': dateRangeJs['months'][11],

        "Apply": dateRangeApply,
        "Cancel": dateRangeCancel
    }
    const tc = (val) => dateRangeMapping[val];
