...
$(document).ready(function() {
    if ($('#SubmitFeature:visible').length) {
        document.querySelector('#SubmitFeature').addEventListener('click', function() {
            setTimeout(() => this.disabled = true)
        });
    }
    if ($('#SubmitFeatureValue:visible').length) {
        document.querySelector('#SubmitFeatureValue').addEventListener('click', function() {
            setTimeout(() => this.disabled = true)
        });
    }
