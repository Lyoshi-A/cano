...
<div class="modal fade" id="reason" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form id="reason-form" action="{$link->getAdminLink('AdminSellerProductDetail')|escape:'htmlall':'UTF-8'}" method="post">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-info" name="submit_btn" id="reason-ok"><span>{l s='Submit' mod='marketplace'}</span></button>
					<button type="button" id="reason-anyway" class="btn btn-info" data-dismiss="modal"><span>{l s='Deactivate anyway' mod='marketplace'}</span></button>
				</div>
			</form>
		</div>
	</div>
