...
<div class="panel">
	...
	<div class="form group">
		<a class="btn btn-link wk_padding_none" href="{$link->getAdminLink('AdminSellerProductDetail')|escape:'htmlall':'UTF-8'}&updatewk_mp_seller_product&id_mp_product={$id_mp_product|escape:'htmlall':'UTF-8'}">
