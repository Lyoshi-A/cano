...
<a {if isset($seller_customer_id)}data-id-seller-customer="{$seller_customer_id|escape:'htmlall':'UTF-8'}"{else}data-id-seller-customer="0"{/if}
data-id-order="{$id_order|escape:'htmlall':'UTF-8'}"
