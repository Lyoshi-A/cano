	...
	<div class="form-group">
		...
		<div class="col-lg-7">
			...
			<div class="wk_seller_lang_block">
				<button type="button" id="supplier_lang_btn" class="btn btn-default dropdown-toggle wk_language_toggle" data-toggle="dropdown">
				...
				<ul class="dropdown-menu wk_language_menu">
					{foreach from=$languages item=language}
						<li>
							<a href="javascript:void(0)" onclick="showSupplierLangField('{$language.name|escape:'htmlall':'UTF-8'}', {$language.id_lang|escape:'htmlall':'UTF-8'});">
