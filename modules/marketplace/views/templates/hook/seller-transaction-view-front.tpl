...
<div class="clearfix modal-header">
    ...
    <div class="col-xs-12 col-sm-7 box-stats color3">
        <h4>{l s='Settlement transaction' mod='marketplace'} </h4>
    </div>
    <div class="col-xs-12 col-sm-4 box-stats color3 wk_padding_none">
        <div class="kpi-content" style="padding-left:30px; font-size:16px;">
            ...
            <span class="value">
                {if isset($objTransaction->date_add)}{$objTransaction->date_add|date_format:"%D"|escape:'htmlall':'UTF-8'}{/if}
            </span>
        </div>
    </div>
</div>
