...
{if isset($wk_ad_footer)}
	<li>
		<a href="{$sellerLink|escape:'htmlall':'UTF-8'}" target="_blank">{l s='Become a Seller' mod='marketplace'}</a>
    </li>
		...
		<footer class='wk_ad_footer'>
			<div class="box">
				...
				<div class="wk_ad_content">
					...
					<a class="btn btn-primary btn-sm" href="{$sellerLink|escape:'htmlall':'UTF-8'}" target="_blank">
