...
{if Configuration::get('WK_MP_SELLER_PRODUCT_EAN')}
	<div class="form-group">
		...
		name="ean13"
		id="ean13"
		value="{if isset($smarty.post.ean13)}{$smarty.post.ean13|escape:'htmlall':'UTF-8'}{else if isset($product_info.ean13)}{$product_info.ean13|escape:'htmlall':'UTF-8'}{/if}"
		maxlength="13" />
	</div>
{/if}
...
{if Configuration::get('WK_MP_SELLER_PRODUCT_UPC')}
	<div class="form-group">
		...
		name="upc"
		id="upc"
		value="{if isset($smarty.post.upc)}{$smarty.post.upc|escape:'htmlall':'UTF-8'}{else if isset($product_info.upc)}{$product_info.upc|escape:'htmlall':'UTF-8'}{/if}"
		maxlength="12" />
	</div>
{/if}
...
{if Configuration::get('WK_MP_SELLER_PRODUCT_ISBN')}
	<div class="form-group">
		...
		name="isbn"
		id="isbn"
		value="{if isset($smarty.post.isbn)}{$smarty.post.isbn|escape:'htmlall':'UTF-8'}{else if isset($product_info.isbn)}{$product_info.isbn|escape:'htmlall':'UTF-8'}{/if}"
		maxlength="13" />
	</div>
{/if}
...
{if Configuration::get('WK_MP_PRODUCT_MPN') && !(_PS_VERSION_ < '1.7.7.0')}
	<div class="form-group">
		...
		name="mpn"
		id="mpn"
		value="{if isset($smarty.post.mpn)}{$smarty.post.mpn|escape:'htmlall':'UTF-8'}{else if isset($product_info.mpn)}{$product_info.mpn|escape:'htmlall':'UTF-8'}{/if}"
		maxlength="40" />
	</div>
{/if}
<!-- Product tags -->
