					...
					<tbody id="supplier_list_tbody">
						{if isset($suppliers)}
							{foreach $suppliers as $supplier}
								...
								<tr>
									<td>
										<input value="{$supplier.id_supplier|escape:'htmlall':'UTF-8'}" type="checkbox"
								...
								<td>
									<input id="supplier_radio_{$supplier.id_supplier|escape:'htmlall':'UTF-8'}"
										value="{$supplier.id_supplier|escape:'htmlall':'UTF-8'}" type="radio"
				...
				{foreach $selected_suppliers_data as $selected_supplier_attr}
					<div class="panel panel-default">
						...
						<div class="{if !isset($backendController)}panel-body{/if}"
							id="supplier_combination_{$selected_supplier_attr[0].id_supplier|escape:'htmlall':'UTF-8'}">
							<div>
								<table class="table">
												...
												<tr>
													...
													<td>
														<input type="text"
															...
															value='{$selected_supplier.product_supplier_reference|escape:'htmlall':'UTF-8'}'
															class="form-control">
													</td>
													<td>
