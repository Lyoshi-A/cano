...
include_once 'WkMpVirtualProduct.php';
include_once 'WkMpPackProduct.php';
include_once 'WkMpSpecificRule.php';
include_once 'WkMpManufacturers.php';
include_once 'WkMpSuppliers.php';
include_once 'WkMpSellerShipping.php';
include_once 'WkMpSellerShippingImpact.php';
include_once 'WkMpSellerShippingCart.php';
include_once 'WkMpLoginBlockPosition.php';
include_once 'WkMpLoginConfigration.php';
include_once 'WkMpLoginContent.php';
include_once 'WkMpLoginParentBlock.php';
