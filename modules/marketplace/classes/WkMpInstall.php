...
class WkMpInstall
{
    ...
    private function getMpTableQueries()
    {
        return [
            ...
            /* Each block settings - registration, feature, content, termscondition */
            ...
            /* All 3 theme's settings - header color, bg color */
    ...
    public function deleteMpTables()
    {
        return Db::getInstance()->execute(
            ...
            `' . _DB_PREFIX_ . 'wk_mp_seller_shipping`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_shipping_impact`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_shipping_cart`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_block_position`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_block_position_shop`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_configration`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_configration_shop`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_configration_lang`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_content`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_content_shop`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_content_lang`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_parent_block`,
            `' . _DB_PREFIX_ . 'wk_mp_seller_login_parent_block_shop`'
        );
    }
}
