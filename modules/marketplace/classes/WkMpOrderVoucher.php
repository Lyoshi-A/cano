...
class WkMpOrderVoucher extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            'order_id' => ['type' => self::TYPE_INT, 'required' => true],
            'seller_id' => ['type' => self::TYPE_INT, 'required' => true],
            'voucher_name' => ['type' => self::TYPE_STRING, 'required' => true],
            'voucher_value' => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice', 'required' => true],
        ],
    ];
