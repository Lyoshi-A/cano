                ...
                if ($product_detail) {
                    if ($product_detail['id_ps_product']) {
                        if (SpecificPrice::exists(
                            ...
                            exit('10');  // A specific price already exists for these parameters
                        } else {
                            return true;
                        }
                    }
        ...
        if ($mpProductId) {
            ...
            if (!empty($combinationMpDetails)) {
                foreach ($combinationMpDetails as $key => $value) {
                    ...
                    array_push(
                        $combinationDetailsWithPsIds,
                        array_merge($value, ['id_product_attribute' => $idProductAttribute])
                    );
                }
            }
            ...
            if ($priceRules) {
                ...
                foreach ($priceRules as $key => $specificPrice) {
                    ...
                    if ($specificPrice['reduction_type'] == 'percentage') {
                        ...
                        $impact = '- ' . WkMpHelper::displayPrice(
                    ...
                    '0000-00-00 00:00:00' && $specificPrice['to'] == '0000-00-00 00:00:00') {
                        ...
                        : '0000-00-00 00:00:00') . $html . $objMP->l('To') . ' ' . ($specificPrice['to']
                        != '0000-00-00 00:00:00' ? $specificPrice['to'] : '0000-00-00 00:00:00');
                    }
                    ...
                    || $specificPrice['price'] == -1) ? '--' :
                        WkMpHelper::displayPrice($price, $current_specific_currency);
                    ...
                    $productPriceRule[$key]['id_group'] = ($specificPrice['id_group'] && isset($groups[$specificPrice['id_group']])) ?
